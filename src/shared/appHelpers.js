...
@media print {
  .app-header, .manager-nav, .client-nav, .client-bottom-nav, .client-order-actions, .mobile-checkout-bar, .cart-sheet, .toolbar, button { display: none !important; }
...
@media (max-width: 900px) {
  ...
  .catalog-layout,
  .catalog-layout > *:not(.order-summary) {
    min-width: 0;
    max-width: 100%;
  }
  .catalog-toolbar {
