...
export const STOREFRONT_INFO_PAGES = [
  ...
  },
  {
    ...
    description:
      "Политика ООО «Клевер»: реквизиты оператора, обработка данных заказа, хранение, cookies и необязательная аналитика.",
  },
  {
    ...
    description:
      "Согласие на обработку данных, указанных при заказе. Реклама и аналитика в него не входят.",
  },
];
