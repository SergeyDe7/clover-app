...
const SLUG_FRAGMENT_TO_PATH = [
  ...
  [/belizna|otbeliv/i, "/catalog/himiya-chistyashchie-sredstva/otbelivateli"],
  [/osvezhitel|vozduha|gold-wind/i, "/catalog/himiya-chistyashchie-sredstva/osvezhiteli-vozduha"],
  ...
  [/airwick|freshmatic|mennyj-ballon|aerosol-osvezh/i, "/catalog/himiya-chistyashchie-sredstva/osvezhiteli-vozduha"],
