...
const SEEDS = {
  ...
  [seedKey("returns", "description")]: {
    ...
    ky: "КЛЕВЕР компаниясында товарды алмаштыруу жана кайтаруу шарттары: товар качан кайтарылышы мүмкүн жана бул үчүн эмне керек.",
    tg: "Шартҳои иваз ва баргардонии мол дар ширкати КЛЕВЕР: кай молро баргардондан мумкин аст ва барои ин чӣ лозим аст.",
  ...
  [seedKey("wholesale", "description")]: {
    ...
    tg: "Таъмини яклухти молҳои хонагӣ ва кимиёи рӯзгор аз ширкати КЛЕВЕР: нархҳои махсус ва шартҳои мувофиқ.",
